...
export const CONFIGURATION_OPTIONS: Record<string, MinesweeperConfig> = {
  ...
  'compiler': {
    ...
    endgame: [
      ...
      'invalid connection',
      'cannot read properties of null (reading "social.timer")',
  ...
  'what': {
    ...
    endgame: [
      ...
      'you are a freethinker with an inventive mind. unfortunately, you have freely thought your way into a number of stupid situations, including this one',
      'welcome to the afterlife',
      'you will get you through this. you are in fact already through it',
      ...
      // 'horus, the lord of hell, is the number one most powerful being in the universe',
