...
export const CONFIGURATION_OPTIONS: Record<string, MinesweeperConfig> = {
  'love': {
    ...
    endgame: [
      ...
      'love hurts',
      `\'i love you, i love you, i love you - and perhaps this is how the whole enormous world, shining all over, can be created\'\n-- vladimir nabokov`,
  ...
  'femininity': {
    ...
    endgame: [
      ...
      `\'i\'m single. i\'m single because i was born that way\'\n-- mae west`,
      ...
      `\'women have curious ways of hurting someone else. they hurt themselves instead; or else they do it so the guy doesn't even know he's been hurt until much later. then he finds out\'\n-- margaret atwood`
    ],
    wingame: [
      'the female body plan is our default condition. take that, adam and eve',
    ],
